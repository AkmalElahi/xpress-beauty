...
export const RoundButton = ({ backgroundColor, fontSize, color, height , value, onPress, disabled}) => (
    <TouchableOpacity disabled={disabled} style={{  height, width: "100%", backgroundColor, borderRadius: 50, alignItems: "center", justifyContent: "center" }} onPress={onPress} >
        {/* <ImageBackground source={btnimg} style={{width:"100%", height:"100%" , justifyContent:"center", alignItems:"stretch"}}>
           
     </ImageBackground> */}
        <Text style={{ fontSize, textAlign: "center", alignSelf: 'center', justifyContent: "center", alignItems: "center", alignContent: "center", color }}>
            {value}
            </Text>
    </TouchableOpacity>
)
